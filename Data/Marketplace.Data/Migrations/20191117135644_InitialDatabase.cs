    ...
    public partial class InitialDatabase : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SellMeUserAddresses", x => new { x.AddressId, x.UserId });
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        name: "FK_SellMeUserAddresses_AspNetUsers_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Ads_Conditions_ConditionId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SellMeUserFavoriteProducts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SellMeUserFavoriteProducts_Ads_AdId",
                        column: x => x.AdId,
                        principalTable: "Ads",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SellMeUserFavoriteProducts_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SellMeUserAddresses_UserId",
                table: "SellMeUserAddresses",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_SellMeUserFavoriteProducts_AdId",
                table: "SellMeUserFavoriteProducts",
                column: "AdId");

            migrationBuilder.CreateIndex(
                name: "IX_SellMeUserFavoriteProducts_UserId",
                table: "SellMeUserFavoriteProducts",
                column: "UserId");
